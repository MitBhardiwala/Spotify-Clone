...
async function getSongs(folder) {
    currFolder = folder;
    let a = await fetch(`https://github.com/MitBhardiwala/Spotify-Clone/tree/main/${folder}/`)
...
async function displayAllAlbums() {
    let a = await fetch(`https://github.com/MitBhardiwala/Spotify-Clone/tree/main/songs/`)
    let response = await a.text();
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/songs/") && !e.href.includes(".htaccess")) {
            ...
            let a = await fetch(`https://github.com/MitBhardiwala/Spotify-Clone/tree/main/songs/${folder}/info.json`)
